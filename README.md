...
Document forensics models that run on the client. This repository holds the
runtime, the examples and the licence. **The weights are not here** — they live
on Hugging Face, so there is one file in the world with one hash.

- Model card and weights: https://huggingface.co/ginexys/docforensics-layout
- npm: `npm install @canwork/docforensics`
- Quickstart: [`docs/QUICKSTART.md`](docs/QUICKSTART.md)
- Commercial licence: [`docs/COMMERCIAL.md`](docs/COMMERCIAL.md)
...
![The same page, clean and blurred](examples/images/02-same-page-degraded.png)

Clean, it ties with the baseline. Blurred, the baseline returns nothing and
this model still returns five regions — and the strip underneath reports the
blur, which is the part no other detector does.

**[More examples, including one this model loses](examples/README.md)**
